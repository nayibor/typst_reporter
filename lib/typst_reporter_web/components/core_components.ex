defmodule TypstReporterWeb.CoreComponents do
  @moduledoc """
  ...
  import TypstReporterWeb.Gettext
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-brand hover:bg-brand-700 py-2 px-3",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TypstReporterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TypstReporterWeb.Gettext, "errors", msg, opts)
    end
  end
